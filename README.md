...
同时你也可以直接在以下入口使用通用方式启动程序，该方式则必须指定配置SOURCE和TARGET，两方账号账号密码以及时间节点，程序会根据SOURCE和TARGET配置情况自动选择执行哪种同步方式：
...
编辑订阅页面最下边还有 “自动添加任务”，“自动删除任务”，这俩开关首次拉代码建议打开。开启后它会把项目里所有的py文件都自动帮你添加任务到定时服务里。
...
---
- 5.运行程序效果：
![运行效果.png](doc/%E8%BF%90%E8%A1%8C%E6%95%88%E6%9E%9C.png)
